...
<!--        <section id="left">-->
        <table class="table-conteiner" cellpadding="0" cellspacing="0">
            <tr>
                            ...
                            <?php if (isset($arr_topics) & count($arr_topics) > 0): ?> 
                                ...
                                <tr>
                                    <td class="thread-item td-subject"><a href="topic.php?id=<?php echo $topic->getId(); ?>&page=1">
                                            <?php
                                            if (empty($topic->getSubject)) {
                                                echo fixTitle($topic->getComment());
                                            } else {
                                                echo fixTitle($topic->getSubject());
                                            }
                                            ?></a>
                                    </td>
